...
class SynPic
{
	...
	function updatepiccate($grow,$link)
	{
		...
		{
			$sql_ins = "insert into sipa_pic_cate(moddate,photoid,cid,groupid,ifmod,zoneid,ifstock) values('".$grow['moddate']."','".$grow['photoid']."','".$cid."','".$grow['groupid']."','".$grow['ifmod']."','".$grow['zoneid']."','".$grow['ifstock']."')";
